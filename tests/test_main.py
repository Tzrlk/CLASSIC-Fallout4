...
def test_mock_yaml(mock_yaml: MockYAML) -> None:
    ...
    CLASSIC_Main.yaml_settings(str, CLASSIC_Main.YAML.Main, "XXXX.XSE_Acronym", "SFSE")
    assert mock_yaml["XSE_Acronym"] == "SFSE"
    mock_yaml.clear()
    assert mock_yaml["XSE_Acronym"] == "F4SE"
    assert CLASSIC_Main.yaml_settings(int, CLASSIC_Main.YAML.Main, "XXXX.Main_SteamID") == 377160
...
def is_read_only(file_path: Path) -> bool:
    return file_path.stat().st_file_attributes & stat.FILE_ATTRIBUTE_READONLY == 1 # type: ignore
...
def test_YamlSettingsCache_get_setting(test_load_yaml: CLASSIC_Main.YamlSettingsCache) -> None:
    ...
    game = test_load_yaml.get_setting(str, CLASSIC_Main.YAML.TEST, "Section 1.Game Name")
    ...
    bool_false = test_load_yaml.get_setting(bool, CLASSIC_Main.YAML.TEST, "Section 1.False Bool")
    assert bool_false is False, "Section 1.False Bool should be False"

    bool_true = test_load_yaml.get_setting(bool, CLASSIC_Main.YAML.TEST, "Section 1.True Bool")
    assert bool_true is True, "Section 1.True Bool should be True"

    int_positive = test_load_yaml.get_setting(int, CLASSIC_Main.YAML.TEST, "Section 1.Positive Int")
    ...
    int_negative = test_load_yaml.get_setting(int, CLASSIC_Main.YAML.TEST, "Section 1.Negative Int")
    ...
    float_positive = test_load_yaml.get_setting(float, CLASSIC_Main.YAML.TEST, "Section 1.Positive Float")
    ...
    float_negative = test_load_yaml.get_setting(float, CLASSIC_Main.YAML.TEST, "Section 1.Negative Float")
    ...
    list_of_str = test_load_yaml.get_setting(list[str], CLASSIC_Main.YAML.TEST, "Section 1.List of Str")
    ...
    alt_list_of_int = test_load_yaml.get_setting(list[int], CLASSIC_Main.YAML.TEST, "Section 1.Alt Syntax List of Int")
    ...
    dict_of_str = test_load_yaml.get_setting(dict[str,str], CLASSIC_Main.YAML.TEST, "Section 1.Dict of Str")
    ...
    return_string_1 = test_load_yaml.get_setting(str, CLASSIC_Main.YAML.TEST, "Section 2.Str Write", random_string)
    assert return_string_1 == random_string, "get_setting() should return the new str value"
    return_string_2 = test_load_yaml.get_setting(str, CLASSIC_Main.YAML.TEST, "Section 2.Str Write")
    ...
    return_int_1 = test_load_yaml.get_setting(int, CLASSIC_Main.YAML.TEST, "Section 2.Int Write", random_int)
    assert return_int_1 == random_int, "get_setting() should return the new int value"
    return_int_2 = test_load_yaml.get_setting(int, CLASSIC_Main.YAML.TEST, "Section 2.Int Write")
    assert return_int_2 == random_int, "get_setting() should return the int value exactly as written"

    random_bool = random.random() < 0.5
    return_bool_1 = test_load_yaml.get_setting(bool, CLASSIC_Main.YAML.TEST, "Section 2.Bool Write", random_bool)
    assert return_bool_1 is random_bool, "get_setting() should return the new bool value"
    return_bool_2 = test_load_yaml.get_setting(bool, CLASSIC_Main.YAML.TEST, "Section 2.Bool Write")
    ...
    return_dict_1 = test_load_yaml.get_setting(dict, CLASSIC_Main.YAML.TEST, "Section 2.Dict Write", random_dict)
    ...
    return_dict_2 = test_load_yaml.get_setting(dict, CLASSIC_Main.YAML.TEST, "Section 2.Dict Write")
    ...
    return_list_1 = test_load_yaml.get_setting(list, CLASSIC_Main.YAML.TEST, "Section 2.List Write", random_list)
    ...
    return_list_2 = test_load_yaml.get_setting(list, CLASSIC_Main.YAML.TEST, "Section 2.List Write")
    ...
    return_value = test_load_yaml.get_setting(str, CLASSIC_Main.YAML.Main, "CLASSIC_Info.version")
...
def test_yaml_settings(test_load_yaml: CLASSIC_Main.YamlSettingsCache) -> None:
    ...
    game = CLASSIC_Main.yaml_settings(str, CLASSIC_Main.YAML.TEST, "Section 1.Game Name")
    assert isinstance(game, str), "Section 1.Game Name should be a string"
    assert game == "Elder Scrolls VI", "Section 1.Game Name should equal 'Elder Scrolls VI'"
...
def test_classic_settings() -> None:
    ...
    update_check = CLASSIC_Main.classic_settings(bool, "Update Check")
